      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              onClick={onOpenCart}
              className="relative p-2 text-gray-700 hover:text-[#7a8d4e] transition-colors"
            ...
            >
              ...
              {cartCount > 0 && (
                <span className="absolute top-0 right-0 inline-flex items-center justify-center px-2 py-1 text-[10px] font-bold leading-none text-white transform translate-x-1/2 -translate-y-1/2 bg-[#7a8d4e] rounded-full" aria-hidden="true">
                  {cartCount}
                </span>
              )}
            </button>
